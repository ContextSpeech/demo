...
<table align="center">
    ...
    <tr>
        ...
        <td>
            <audio controls style="width: 150px;"><source src="Samples/Recording/1.wav"></audio><br>
        </td>
    </tr>
    <tr>
        <td width="60%" style="word-wrap:break-word;">
        ...
        <td>
            <audio controls style="width: 150px;"><source src="Samples/Recording/2.wav"></audio><br>
        </td>
    </tr>  
</table>
